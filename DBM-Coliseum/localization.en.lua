...
L:SetOptionLocalization{
	...
	SpecialWarnOnDebuff			= "Show special warning when debuffed by the opposite color",
	SpecialWarnOnDebuffSame		= "Show special warning when debuffed by the same color",
	YellOnOppositeDebuff		= "Yell on opposite color touch",
...
L:SetOptionLocalization{
	...
	PlayPColdCountdown			= "Show and count down cooldown timer for $spell:68510 in Phase 3",
