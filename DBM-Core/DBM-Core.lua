...
-------------------------------
DBM = {
	Revision = ("$Revision: 9010 $"):sub(12, -3),
	Version = "9.11",
	DisplayVersion = "9.11-Dalaran", -- the string that is shown as version
	ReleaseRevision = 9010 -- the revision of the latest stable version that is available (for /dbm ver2)
}
